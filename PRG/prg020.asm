...
Tile_Layout_TS9:
    ...
    hex FC 4E FE 05 05 E8 FF 58 FF FF 5D 5F FE FF FF FF FF FF FF 48 4A FC 57 FC FC FC FC 42 FC 33 32 05 58 05 05 5D 5F FE 4E 42 FE 48 4A FE 39 FF B8 B8 B8 B8 BC 44 34 4E 4C 4C FD FD FE FF FF FF FF FF DC 05 FE FE 05 05 05 05 60 D5 B2 FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF D8 98 98 98 98 98 98 92 B4 B4 B4 B4 B4 B4 B4 B4 B4 B4 B8 C0 C0 C0 C0 A4 EC E4 C0 D5 B2 FF FF FF FF 05 50 50 50 50 C4 05 7E 7E 04 FF FF FF FF FF FF 69 6B 78 7A 6E FE 6E FE FE 05 0E 02 05 18 1A 05 04 77 1C 77 77 1E 77 10 12 0E 77 77 12 8C 8E 8C 8E 8C 8E 8C 8E 75 75 67 4D 65 39 AE B8 8C 8E 77 76 05 3C FE FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF B3 CC FC C5 C7 D4 FE FC AA AB FE 2C 20 FE 28 2A FE 30 77 24 77 77 26 3B 60 D7 E0 FF 77 72 38 2C 77 77 38 77 FE FF FF FF

    ; Lower left 8x8 pattern per tile
    hex FC 4F FE 06 D6 E9 FF FD 5B FF FF FF 46 FF FF FF FF FF FF 24 26 FC 57 FC 33 45 FC 42 FC FC FC 06 FD 5B 06 06 06 40 4C 4C 48 4C 4C 4A 4C FF B9 B9 B9 B9 BD 34 34 4C 4C 4C FD 4C FE FF FF FF FF FF DD 06 FE FE 06 06 06 06 61 B2 B2 FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF D9 99 99 99 99 99 99 93 B5 B5 B5 B5 B5 B5 B5 B5 B5 B5 B9 C1 C1 C1 C1 A5 ED E4 C1 B2 B2 FF FF FF FF 06 52 52 52 52 C4 06 FE FE 76 FF FF FF FF FF FF 6D 6F 78 FE 6E FE 6E FE FE 00 77 77 18 77 77 1A 06 0A 06 1C 1E 06 0C 13 13 77 77 77 16 35 9E 35 9E 35 9E 35 9E 76 76 74 64 66 39 AE B9 35 9E 0C 76 06 FE FE FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF E6 CD CD CD FE FE FE FE FE AB AB 22 77 77 28 77 77 2A FE 32 FE 24 26 FE 77 61 FF E1 FF 2E 3A 3A 77 77 77 7E 2E FE FF FF FF

    ; Upper right 8x8 pattern per tile
    hex FC FC FE 07 07 EA FF 59 FF 5C 5E FF FE FF FF FF FF FF FF 49 4B 56 FC FC FC FC 42 FC 40 33 FC 07 59 07 5C 5E 07 40 4F FE FE 49 4B FE 39 FF BA BA BA BA BE 4F 4C 45 36 4C FD 4C FE FF FF FF FF FF DE 07 FE FE 07 07 07 07 62 D5 B2 FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF DA 9A 9A 9A 9A 9A 9A CA B6 B6 B6 B6 B6 B6 B6 B6 B6 B6 BA C2 C2 C2 C2 A6 EE E5 C2 D5 B2 FF FF FF FF 07 51 51 51 51 C6 07 7F 3E 7E FF FF FF FF FF 68 6A FF 79 7B FE 6F FE 6F FE 01 0F 07 07 19 1B 07 77 0B 1D 77 77 1F 77 0F 77 11 14 77 77 8D 8F 8D 8F 8D 8F 8D 8F 41 41 3E 4D 65 AD 3B BA 8D 8F 14 76 07 3C FE FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF B3 CE FC C5 C7 D4 FE FC AA AB 23 2D FE FE 29 2B FE 77 33 25 77 77 27 3B 62 D7 E2 FF 77 2D 77 73 70 77 77 70 FE FF FF FF

    ; Lower right 8x8 pattern per tile
    hex FC FC FE 08 D6 EB 5A FF FF FF FF FF 47 FF FF FF FF FF FF 25 27 56 FC 44 33 FC 42 FC FC FC FC 5A FD 08 08 08 08 4C 4C 42 49 4C 4C 4B 4C FF BB BB BB BB BF 4C 4C 36 36 4C FD FE FE FF FF FF FF FF DF 08 FE FE 08 08 08 08 63 B2 B2 FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF DB 9B 9B 9B 9B 9B 9B CB B7 B7 B7 B7 B7 B7 B7 B7 B7 B7 BB C3 C3 C3 C3 A7 EF E5 C3 B2 B2 FF FF FF FF 08 53 53 53 53 C6 08 FE 3F FE FF FF FF FF FF 6C 6E FF 79 7D FE 6F FE 6F FE 77 77 03 19 77 77 1B 09 08 08 1D 1F 08 0D 77 77 15 15 77 0D 9D 37 9D 37 9D 37 9D 37 43 43 3F 64 66 AD 3B BB 9D 37 17 76 08 FE FE FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF E7 CF CF CF FE FE FE FE FE AB AB 77 77 21 29 77 77 2B 31 FE FE 25 27 FE 77 63 FF E3 FF 2F 77 77 71 71 77 2F 7F FE FF FF FF
...
TS9_SkyStopGen:		; Stop palms from overflowing to top of screen
	LDA #TILE9_SKY_STOPGEN
	JSR Tile_Mem_ClearA
	INY
	CPY #$10
	BNE TS9_SkyStopGen
...
LoadLevel_Generator_TS9:
    ...
    CLC
    ADC PRG020_A425,X   ; Add multiple of 15
    TAX
    DEX
...
LeveLoad_FixedSizeGen_TS9:
    ...
    .word LoadLevel_DesertTree		; 43 - Place a palmtree
...
@DrawTop:
    ...
    TYA
    AND #$0f
    BNE @SkyCheck  ; If crossed screen boundary, check if next tile is sky
...
@DrawTrunk:
    ...
    JMP @SkyCheck			; draw more trunk or finish
